...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory {
        private final AndroidxUiGraphicsLibraryAccessors laccForAndroidxUiGraphicsLibraryAccessors = new AndroidxUiGraphicsLibraryAccessors(owner);
        private final AndroidxUiToolingLibraryAccessors laccForAndroidxUiToolingLibraryAccessors = new AndroidxUiToolingLibraryAccessors(owner);

        public AndroidxUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.ui.graphics</b>
         */
        public AndroidxUiGraphicsLibraryAccessors getGraphics() {
            return laccForAndroidxUiGraphicsLibraryAccessors;
        }
    ...
    public static class AndroidxUiGraphicsLibraryAccessors extends SubDependencyFactory {

        public AndroidxUiGraphicsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.compose.ui:ui-graphics-android</b> coordinates and
         * with version reference <b>uiGraphicsAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("androidx.ui.graphics.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigationRuntimeKtx</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>runtimeAndroid</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiGraphicsAndroid</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUiGraphicsAndroid() { return getVersion("uiGraphicsAndroid"); }

        /**
         * Version alias <b>uiToolingPreviewAndroid</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
